<?php
// File: resources/views/tour/create_tour.php
$pageTitle = "Tambah Paket Wisata Baru - IndoTour";
...
<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="mb-8">
        <h1 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Tambah Paket Wisata Baru</h1>
    </div>

    <div class="bg-white border border-slate-200 p-6 sm:p-8 rounded-2xl shadow-sm">
        <form action="/admin/tours/create" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
                    ...
                    <div>
                        ...
                        <input id="duration_days" name="duration_days" type="number" min="1" required value="1"
                            class="block w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3.5 text-sm text-slate-800 font-medium focus:border-teal-500 focus:bg-white focus:outline-none focus:ring-1 focus:ring-teal-500 transition-all">
                    </div>
                    <div>
                ...
                <div>
                    <label for="cover_image" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2">Gambar Cover Utama Paket</label>
                    <input id="cover_image" name="cover_image" type="file" accept="image/*" required
            ...
            <div class="pt-8 border-t border-slate-200 flex justify-end">
                <button type="submit" 
                    ...
                    <i data-lucide="save" class="w-4 h-4"></i> Simpan Paket Wisata
                </button>
            </div>
        </form>
    </div>
