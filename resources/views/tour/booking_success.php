...
<div class="mx-auto max-w-md px-4 py-16 text-center">
    ...
    <h1 class="text-3xl font-extrabold text-white tracking-tight mb-2"><?php echo e(translate('Pembayaran Berhasil!', 'Payment Successful!')); ?></h1>
    ...
    <div class="bg-slate-950/40 border border-slate-800/80 rounded-2xl p-6 text-left mb-8 space-y-4 text-xs">
        ...
        <div class="flex justify-between items-center">
            ...
            <span class="font-bold text-slate-200"><?php echo e(date('d M Y', strtotime($booking['travel_date']))); ?></span>
        </div>
        <div class="flex justify-between items-center">
            <span class="text-slate-500 font-bold">JUMLAH PESERTA</span>
            <span class="font-bold text-slate-200"><?php echo e($booking['total_participants']); ?> pax</span>
        </div>
        <div class="flex justify-between items-center border-t border-slate-900 pt-3 text-sm font-bold">
            ...
            <span class="text-teal-400"><?php echo e(format_rupiah($booking['total_price'])); ?></span>
        </div>
    </div>
    ...
    <div class="flex flex-col sm:flex-row gap-4 justify-center">
        <a href="/dashboard" class="w-full sm:w-auto px-6 py-2.5 rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 text-slate-950 font-bold text-sm hover:opacity-90 hover:scale-[1.01] active:scale-[0.99] transition-all">
            <i data-lucide="trending-up" class="mr-1"></i> <?php echo e(translate('Buka Dashboard', 'Go to Dashboard')); ?>
        </a>
