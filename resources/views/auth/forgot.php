...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 class="mt-6 text-center text-3xl font-black tracking-tight text-slate-900">
            <?php echo translate('Lupa Kata Sandi', 'Forgot Password'); ?>
        </h2>
        <p class="mt-2 text-center text-sm text-slate-500">
            <?php echo translate('Kembali ke', 'Back to'); ?>
            <a href="/login" class="font-bold text-teal-600 hover:text-teal-500 transition-colors">
                <?php echo translate('halaman masuk', 'sign in page'); ?>
            </a>
        </p>
    </div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white border border-slate-200 px-6 py-8 shadow-sm rounded-2xl sm:px-10">
            <form class="space-y-6" action="/forgot" method="POST">
                ...
                <div>
                    <label for="email"
                        class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2"><?php echo translate('Masukkan Email Terdaftar', 'Enter Registered Email'); ?></label>
                ...
                <div class="pt-2">
                    <button type="submit"
                        ...
                        <?php echo translate('Kirim Tautan Reset', 'Send Reset Link'); ?>
                    </button>
                </div>
            </form>
        </div>
