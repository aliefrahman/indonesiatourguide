...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 class="mt-6 text-center text-3xl font-black tracking-tight text-slate-900">
            <?php echo e(translate('Buat Sandi Baru', 'Create New Password')); ?>
        </h2>
    </div>
    ...
    <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div class="bg-white border border-slate-200 px-6 py-8 shadow-sm rounded-2xl sm:px-10">
            <form class="space-y-6" action="/reset" method="POST">
                ...
                <div>
                    <label for="password" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(translate('Kata Sandi Baru', 'New Password')); ?></label>
                ...
                <div>
                    <label for="password_confirm" class="block text-xs font-bold text-slate-500 uppercase tracking-wider mb-2"><?php echo e(translate('Konfirmasi Kata Sandi', 'Confirm Password')); ?></label>
                    <div class="mt-1.5 relative rounded-md shadow-sm">
                        <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3.5 text-slate-400">
                            <i data-lucide="lock" class="w-4 h-4"></i>
                        </div>
                ...
                <div class="pt-4 border-t border-slate-100">
                    <button type="submit" 
                        ...
                        <i data-lucide="check" class="w-4 h-4"></i> <?php echo e(translate('Perbarui Kata Sandi', 'Update Password')); ?>
                    </button>
                </div>
            </form>
        </div>
