<?php
// File: resources/views/users/create_users.php
$pageTitle = "Tambah Pengguna Baru - IndoTour";
...
<div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="mb-8">
        <h1 class="text-2xl sm:text-3xl font-black text-slate-900 tracking-tight">Tambah Pengguna Baru</h1>
    </div>
        ...
        <form action="/admin/users/create" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select id="role" name="role" required
                        class="block w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 px-3.5 text-sm text-slate-800 font-medium focus:border-teal-500 focus:bg-white focus:outline-none focus:ring-1 focus:ring-teal-500 transition-all">
                        <option value="traveler">Traveler (Visitor)</option>
            ...
            <div class="pt-8 border-t border-slate-200 flex justify-end">
                <button type="submit" 
                    ...
                    <i data-lucide="save" class="w-4 h-4"></i> Simpan Pengguna
                </button>
            </div>
        </form>
    </div>
